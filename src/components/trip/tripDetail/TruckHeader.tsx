...
const TruckHeader: React.FC<TruckHeaderProps> = ({ truck, driver }) => {
  ...
  return (
    <div className="flex justify-between items-center p-7 bg-gradient-to-r from-bottomNavBarColor via-bottomNavBarColor to-lightOrange rounded-lg shadow-lg text-white">
