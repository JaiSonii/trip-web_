...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-lightOrangeButtonColor text-buttonTextColor transform duration-100 ease-in-out hover:cursor-pointer ",
      className
    )}
    {...props}
  >
